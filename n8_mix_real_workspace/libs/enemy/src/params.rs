...
pub const HEALTH: f32 = 9.0;

pub const PHYSICS_SIZE:f32 = 32.0;
pub const BODY_SIZE: f32 = 70.0;
...
// ================================
// STRUCTURE
pub const ROOT_SIZE: Vec2 = Vec2::new(56.0, 8.0);
pub const ROOT_COLOUR: Color = Color::DARK_GRAY;

pub const TREE_ROOT_SIZE: Vec2 = Vec2::new(68.0, 8.0);
pub const TREE_ROOT_OFFSET: Vec3 = Vec3::new(0.0, 6.0, 0.0);
pub const TREE_ROOT_COLOUR: Color = Color::GRAY;

pub const HUB_SIZE: Vec2 = Vec2::new(64.0, 64.0);
pub const HUB_OFFSET: Vec3 = Vec3::new(0.0, 36.0, 0.0);
pub const HUB_COLOUR: Color =  Color::hsl(60.0, 1.0, 0.7);

pub const CHASE_SIZE: Vec2 = Vec2::new(24.0, 24.0);
pub const CHASE_OFFSET: Vec3 = Vec3::new(32.0, 70.0, 0.0);

pub const DEFEND_SIZE: Vec2 = Vec2::new(24.0, 24.0);
pub const DEFEND_OFFSET: Vec3 = Vec3::new(32.0, 70.0, 0.0);

pub const WILDCARD_SIZE: Vec2 = Vec2::new(24.0, 24.0);
pub const WILDCARD_OFFSET: Vec3 = Vec3::new(32.0, 70.0, 0.0);

pub const MOTIF_SIZE: Vec2 = Vec2::new(24.0, 8.0);
pub const MOTIF_OFFSET: Vec3 = Vec3::new(0.0, 0.0, 0.1);
pub const MOTIF_PIVOT: Vec2 = Vec2::new(0.4 , 0.);
pub const MOTIF_COLOUR: Color = Color::DARK_GRAY;

pub const DEATH_FLARE_COLOUR: Color = Color::YELLOW;
pub const DEATH_FLARE_WIDTH: f32 = 56.0;
pub const DEATH_FLARE_FADE: f32 = 0.75;

pub const CHASE_NECK_OFFSET: Vec3 = Vec3::new(32.0, 70.0, 0.0);
pub const DEFEND_NECK_OFFSET: Vec3 = Vec3::new(32.0, 70.0, 0.0);
pub const WILDCARD_NECK_OFFSET: Vec3 = Vec3::new(32.0, 70.0, 0.0);

// ================================
// LASERS
pub const CHASE_LASER_COLOUR: Color = CHASE_COLOUR;
pub const CHASE_LASER_WIDTH: f32 = 8.0;
pub const CHASE_LASER_FADE: f32 = 3.0;

pub const DEFEND_LASER_COLOUR: Color = DEFEND_COLOUR;
pub const DEFEND_LASER_FADE: f32 = 3.0;
pub const DEFEND_LASER_WIDTH: f32 = 8.0;

pub const WILDCARD_LASER_COLOUR: Color = WILDCARD_COLOUR;
pub const WILDCARD_LASER_WIDTH: f32 = 8.0;
pub const WILDCARD_LASER_FADE: f32 = 3.0;

// ================================
// CHASE BEHAVIOUR
pub const CHASE_COLOUR: Color = Color::hsl(220.0, 0.9, 0.6);
pub const CHASE_FRENZY_COLOUR: Color = Color::hsl(340.0, 1.0, 0.5);
pub const CHASE_FRENZY_TO_COLOUR_MIN_MAX: Vec2 = Vec2::new(0.0, 3.75);
...
pub const CHASE_NECK_MAX: f32 = 18.0; // Determines max neck extension.

// ================================
// DEFEND BEHAVIOUR
pub const DEFEND_COLOUR: Color = Color::hsl(140.0, 0.9, 0.6);
pub const DEFEND_FRENZY_COLOUR: Color = Color::hsl(20.0, 1.0, 0.5);
pub const DEFEND_FRENZY_TO_COLOUR_MIN_MAX: Vec2 = Vec2::new(0.0, 3.75);
...
pub const DEFEND_NECK_MAX: f32 = 6.0;  // Determines max neck extension.
...
pub const WILDCARD_RANDOM_WAYPOINT_BOUNDS: Vec2 = Vec2::new(2000.0, 1000.0);
pub const WILDCARD_WAYPOINT_COMPLETION_DISTANCE: f32 = 10.0;
pub const WILDCARD_WAYPOINT_REFRESH_TIMER_RANG: Vec2 = Vec2::new(2.0, 20.0);

pub const WILDCARD_BODY_AUTHORITY: f32 = 0.1;
pub const WILDCARD_HEAD_AUTONOMY: f32 = 1.0;
pub const WILDCARD_BODY_PULL: f32 = 0.2;
pub const WILDCARD_NECK_GROWTH: f32 = 1.0;
pub const WILDCARD_NECK_MIN: f32 = 2.0;
pub const WILDCARD_NECK_MAX: f32 = 4.0;
...
pub const WILDCARD_HEAD_PULL: f32 = 0.33;
pub const WILDCARD_BODY_MOVE_BASE_SPEED: f32 = 0.0;
pub const WILDCARD_MOVE_LIMIT: f32 = 6.0;
pub const WILDCARD_FRENZY_DOMINANCE: f32 = 1.4;
pub const WILDCARD_BASE_DOMINANCE: f32 = 0.0;

pub const WILDCARD_PERSONA_SWITCHING_HEALTH_THRESHOLD: f32 = 0.5; // Percentage current health
pub const WILDCARD_PERSONA_ACTIVATION_TIME_RANGE: Vec2 = Vec2::new(3.0, 12.0);
pub const WILDCARD_PERSONA_DURATION_TIME_RANGE: Vec2 = Vec2::new(3.0, 12.0);

pub const WILDCARD_COLOUR: Color = Color::hsl(180.0, 0.8, 0.8);
pub const WILDCARD_FRENZY_COLOUR: Color =  Color::hsl(50.0, 0.7, 0.7);
pub const WILDCARD_FRENZY_COLOUR_MIN_MAX: Vec2 = Vec2::new(0.0, 5.0);

pub const WILDCARD_CHASE_PERSONA_COLOUR: Color = CHASE_COLOUR;
pub const WILDCARD_CHASE_PERSONA_FRENZY_COLOUR: Color = CHASE_FRENZY_COLOUR;
pub const WILDCARD_CHASE_PERSONA_FRENZY_COLOUR_MIN_MAX: Vec2 = CHASE_FRENZY_TO_COLOUR_MIN_MAX;

pub const WILDCARD_DEFEND_PERSONA_COLOUR: Color = DEFEND_COLOUR;
pub const WILDCARD_DEFEND_PERSONA_FRENZY_COLOUR: Color = DEFEND_FRENZY_COLOUR;
pub const WILDCARD_DEFEND_PERSONA_FRENZY_COLOUR_MIN_MAX: Vec2 = DEFEND_FRENZY_TO_COLOUR_MIN_MAX;

pub const WILDCARD_DEFEND_PERSONA_FRENZY_SCALAR: f32 = 1.5;
pub const WILDCARD_CHASE_PERSONA_FRENZY_SCALAR: f32 = 1.5;
