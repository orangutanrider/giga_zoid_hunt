...
use crate::rts_controller::rapier_queries::RtsCommanderRapierQueries;
...
fn command_attack (
    ...
    rapier_queries: RtsCommanderRapierQueries,
) {
    ...
    if let Some(enemy_cast) = enemy_cast {
        order = OrderType::AttackTarget(AttackTargetOrder::new())
    }
