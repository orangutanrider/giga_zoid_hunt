...
pub fn detector_update(
    mut detector_q: Query<(&mut CircleIntersectSoulDetector, &GlobalTransform, &AdditionalDetectorFilter)>, 
...
fn target_detect(
    ...
    let target_unit_group = group_q.get(target);
